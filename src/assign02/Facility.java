...
public class Facility {
	...
	public boolean addPatient(CurrentPatient patient) {
		if( this.patientList.contains(patient)){return false;}
		else{
	...
	public CurrentPatient lookupByUHID(UHealthID patientID) {
		for(CurrentPatient patient: this.patientList) {
	...
	public void setPhysician(UHealthID patientID, int physician) {
		CurrentPatient modify = this.lookupByUHID(patientID);
		if(modify != null) {
			modify.updatePhysician(physician);
		}
	}
